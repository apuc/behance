...
<div class="payment-index">
    ...
    <form method='get' action='http://www.free-kassa.ru/merchant/cash.php'>
        ...
        <input type="submit" onsubmit="gtag('event', 'payment', { 'event_category': 'form', 'event_action': 'payment', }); yaCounter51223025.reachGoal('payment'); return true;" value="Оплатить" class="btn btn-pink">
    </form>
